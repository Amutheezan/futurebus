/******************************
  Program "sets.m" compiled by "Murphi Release 3.1"
...
void mu_1_set_t::set_self(char *n, int os)
{
  ...
  mu_n.set_self_2(name, ".n", os + 96 );
  mu_numIns.set_self_2(name, ".numIns", os + 104 );
  mu_numDel.set_self_2(name, ".numDel", os + 136 );
}
